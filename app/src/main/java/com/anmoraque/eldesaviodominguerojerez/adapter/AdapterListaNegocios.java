    ...
    public NegociosViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        negociosViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Negocios negocios_tocado = lista_negocios_distrito.get(negocio_tocado);
                //Mediante un Intent mando el enlace a Google maps del negocio tocado
                String url_maps = negocios_tocado.getEnlace_maps();
