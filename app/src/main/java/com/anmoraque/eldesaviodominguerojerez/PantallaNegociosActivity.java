...
public class PantallaNegociosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Negocios negocio4 = new Negocios(3, 0, R.drawable.prueba, "El Capricho Gourmet", "Tienda típica con alimentación y bebidas.","9:30 – 14:30", "Callejón de los Bolos, 24", "https://goo.gl/maps/48JvndAp7jMp7one8");
        ...
        Negocios negocio7 = new Negocios(6, 0, R.drawable.seis, "Kiosco Juan Carlos", "Tienda típica con alimentación, chuches y bebidas.","9:30 – 15:00", "Calle Contadora", "https://goo.gl/maps/7AAVwYMhWBKMPaUw6");
        Negocios negocio8 = new Negocios(7, 0, R.drawable.siete, "Alimentación confitería Gabriela", "Tienda típica con alimentación, chuches y bebidas.","9:30 – 14:00", "Calle Contadora, 5Z", "https://goo.gl/maps/bYxZDVykGt4Nq5K6A");
        ...
        Negocios negocio10 = new Negocios(9, 0, R.drawable.nueve, "Alimentación San Joaquin", "Tienda típica con alimentación, chuches y bebidas.","9:30 – 14:00", "Avenida de Sudamérica, 9", "https://goo.gl/maps/G4hRHAAMgezbyVYe9");
        Negocios negocio11 = new Negocios(10, 0, R.drawable.prueba, "La Esquinita", "Tienda típica con alimentación, chuches y bebidas.","9:30 – 15:00", "Calle Santo Domingo", "https://goo.gl/maps/5LwVnQ5h7tdr9vhz8");
